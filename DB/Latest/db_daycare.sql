...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2024 at 08:06 AM
...
(18, 'monday', 'morning,afternoon', 'drawing,lunch,playtime');
...
(33, 'vallakulam', 'Muhammed', '56', 'male', '585665', '12th', '1997-01-29', '2024-10-18', 'mulavili', 'muham123', '9155365634', 'img3.jpg', 'muhammed@gmail.com', 0, '9');
...
(30, '1', 33, 1, '10:50', '15:00'),
(31, '1', 33, 0, '08:00', '16:00');
...
(55, 'kjhhuhuuh', 'Kiran', 'male', '2024-08-08', '9145323678', 'gftftfutf(h)', 'axsadfgdfg', '2024-10-11', '180-1800764_neverland-friends-clipart-13-toddler-clipart-hd-png.png', 13, 10, 34),
(56, 'hjujjkdk', 'Joy                                               ', 'male', '2024-10-25', '9132456785', 'pulikathu(h)', 'joseph', '2024-10-16', '180-1800764_neverland-friends-clipart-13-toddler-clipart-hd-png.png', 16, 13, 37);
...
(34, '2024-10-04', 55, 1, '09:00', '16:05');
...
INSERT INTO `tbl_user` (`user_id`, `user_location`, `user_name`, `user_gender`, `user_age`, `user_contact`, `user_email`, `user_password`, `user_photo`, `place_id`, `user_squestion`, `user_sanswer`) VALUES
...
(34, 'kiuuuu', 'Aliya', 'female', '32', '7015346767', 'aliya@gmail.com', 'annu@786', 'user-profile-icon-free-vector.jpg', 9, '', ''),
(35, 'ssffgf', 'John', 'male', '45', '9165437625', 'john90@gmail.com', 'John*654', 'download.jpeg', 18, 'which is your fav colour', 'red'),
(36, 'gthhgtyt', 'Geethu', 'female', '45', '7012345676', 'geethu09@gmail.com', 'geeth#98', 'user-profile-icon-free-vector.jpg', 11, 'which is your fav flower', 'rose'),
(37, 'hftuftuftu', 'Elna', 'female', '45', '7012030787', 'elna@gmail.com', 'ely&78', 'user-profile-icon-free-vector.jpg', 9, 'which is your fav flower', 'lily');
...
--
ALTER TABLE `tbl_boardingtype`
  MODIFY `boardingtype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tbl_dutytype`
  MODIFY `dutytype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `tbl_ratesetting`
  MODIFY `ratesetting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `tbl_staff`
--
ALTER TABLE `tbl_staff`
  MODIFY `staff_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `tbl_toddler`
  MODIFY `toddler_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `tbl_toddlerattendance`
--
ALTER TABLE `tbl_toddlerattendance`
  MODIFY `toddleratendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
