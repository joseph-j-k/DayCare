    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            ...
            <span class="system-menu__title">Dashboard</span>
                ...
                <li>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            ...
                            <a href="ViewComplaint.php">View Comaplaints</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon paper" aria-hidden="true"></span>Boarding
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="Boardingtype.php">Boarding Type</a>
                        </li>
                        <li>
                            <a href="Ratesetting.php">Rate Setting</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon paper" aria-hidden="true"></span>Food 
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="FoodSection.php">Food Section</a>
                        </li>
                        <li>
                ...
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon paper" aria-hidden="true"></span>Duity
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                    <li>
                            <a href="Dutytype.php">Duity Type</a>
                        </li>
                        <li>
                            <a href="Assignduty.php">Assign Duity</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <ul class="sidebar-body-menu">
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon user-3" aria-hidden="true"></span>Staff 
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        ...
                        <li>
                            <a href="Accepted.php">Accept Staff</a>
                        </li>
                        <li>
                            <a href="Rejected.php">Reject Staff</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon user-3" aria-hidden="true"></span>Toddler
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="ToddlerVerification.php">Toddler Verification</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="show-cat-btn" href="##">
                        <span class="icon user-3" aria-hidden="true"></span>Staff Attendance
                        <span class="category__btn transparent-btn" title="Open list">
                            <span class="sr-only">Open list</span>
                            <span class="icon arrow-down" aria-hidden="true"></span>
                        </span>
                    ...
                    <ul class="cat-sub-menu">
                        <li>
                            <a href="StaffAttendance.php">Staff Attendance</a>
                            <a href="Mark.php">Mark</a>
                            <a href="Unmark.php">UnMark</a>
                        </li>
                    </ul>
                </li>
                <li>
